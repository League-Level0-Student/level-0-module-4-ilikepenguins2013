...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		question2 = new JLabel("<html>Which one is a real fruit? <br> A: Potato <br> B: Tomato <br> C: Carrot</html>");
		question3 = new JLabel("<html>Which is not a real fruit? <br> A: Blueberry <br> B: Rasberry <br> C: Chicken</html>");
		question4 = new JLabel("<html>Which is not a real fruit? <br> A: Basil <br> B: Apple <br> C: Watermelon</html>");
		question5 = new JLabel("<html>Bravo! you completed the quiz, now go use ur smarts to help the world, if you dont imma hunt you down you will not survive </html>");
	}
